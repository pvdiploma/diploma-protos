...
type Event struct {
	...
	TicketAmount int32                  `protobuf:"varint,10,opt,name=ticket_amount,json=ticketAmount,proto3" json:"ticket_amount,omitempty"`
...
func (x *EventCategory) GetAmount() int32 {
	if x != nil {
		return x.Amount
	}
	return 0
...
var file_event_event_proto_rawDesc = []byte{
	...
	0x18, 0x0a, 0x20, 0x01, 0x28, 0x05, 0x52, 0x0c, 0x74, 0x69, 0x63, 0x6b, 0x65, 0x74, 0x41, 0x6d,
